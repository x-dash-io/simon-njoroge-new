            ...
            <li key={link.href} className="flex-shrink-0">
              <Link
                ...
                className={`flex justify-center items-center h-10 w-10 md:h-auto md:w-auto md:px-4 md:py-2 rounded-full text-sm transition-colors duration-200 ${
                  isActive
                    ? 'bg-cyan-600 dark:bg-cyan-500 text-white scale-110' // Adjusted active colors
                    : 'text-neutral-700 dark:text-neutral-200 hover:bg-neutral-200/60 dark:hover:bg-neutral-700/60' // Adjusted default/hover
                }`}
              >
